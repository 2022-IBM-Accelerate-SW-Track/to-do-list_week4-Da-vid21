...
class AddTodo extends Component {
  ...
  render() {
    return (
      /** 1. When rendering a component, you can render as many elements as you like as long as it is wrapped inside one div element.
       2. The return statement should include a text field input with the handleChange function from above that is passed into an onChange event.
       3. The return should also include a button with the handleSubmit function from above that is passed into an OnClick event.
